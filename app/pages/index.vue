            ...
            <section v-else class="flex w-full flex-col gap-6 py-5 sm:py-8">
              ...
              <template v-if="!isLimitedAdmin && (wizard.step.value === 0 || wizard.step.value === 1)">
                ...
                <OrganismsTournamentStepPlayers
                  ...
                  :vk-list-limit="wizard.vkListLimit.value"
                  :queued-players="wizard.queuedPlayers.value"
                  ...
                  @set-vk-list-limit="(limit) => wizard.setVkListLimit(limit)"
              ...
              <OrganismsTournamentStepStandings
                ...
                :remote-snapshot="viewerState?.standingsSnapshot ?? null"
                :remote-match-status="viewerState?.matchStatus ?? null"
                :remote-live-home-team="viewerState?.liveHomeTeam ?? null"
                :remote-live-away-team="viewerState?.liveAwayTeam ?? null"
