  ...
  <div class="flex min-h-full flex-col bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-slate-100">
    ...
    <main class="mx-auto w-full max-w-4xl flex-1 px-0 py-5 sm:px-6 sm:py-8 pt-[calc(theme(spacing.14)+env(safe-area-inset-top))] print:!pt-6 print:max-w-none">
      ...
      <div
        ...
        class="mx-3 flex flex-col items-center gap-4 rounded-2xl border border-dashed border-slate-300 dark:border-slate-700/60 px-6 py-16 text-center sm:mx-0"
      >
      ...
      <div
        v-else-if="error"
        class="mx-3 flex flex-col items-center gap-3 rounded-2xl border border-dashed border-red-300 dark:border-red-800/50 px-6 py-12 text-center sm:mx-0"
      >
      ...
      <div
        ...
        class="w-full overflow-visible bg-transparent print:border-slate-300 print:shadow-none sm:overflow-hidden sm:rounded-2xl sm:border sm:border-slate-200 sm:bg-slate-100 sm:dark:border-slate-700/50 sm:dark:bg-slate-900/60"
      >
