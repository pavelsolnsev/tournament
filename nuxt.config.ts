  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'description', content: 'Онлайн-турниры РФОИ в Раменском — live результаты матчей, таблица standings, архив прошлых турниров. Следи за ходом игры в реальном времени. Раменское, Московская область.' },
        ...
        { property: 'og:description', content: 'Онлайн-турниры РФОИ — live результаты матчей, таблица standings и архив турниров любительского футбола в Раменском.' },
        ...
        // Пустая картинка нужна, чтобы соцсети не брали иконку или фото со страницы сами.
        { property: 'og:image', content: 'https://tournament.pavelsolntsev.ru/seo-empty-preview.png' },
        { property: 'og:image:secure_url', content: 'https://tournament.pavelsolntsev.ru/seo-empty-preview.png' },
        { property: 'og:image:type', content: 'image/png' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },
        { name: 'twitter:card', content: 'summary' },
        { name: 'twitter:image', content: 'https://tournament.pavelsolntsev.ru/seo-empty-preview.png' },
      ...
      script: [
        // Schema.org: спортивная организация для поисковиков.
        {
          ...
          innerHTML: JSON.stringify({
            ...
            alternateName: 'РФОИ',
            description: 'Онлайн-турниры РФОИ — live результаты матчей, таблица standings и архив турниров любительского футбола в Раменском.',
